  ...
  return (
    <section id="team" className="bg-surface py-24">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <h2 className="font-heading text-4xl font-bold text-text-dark mb-12">
          Meet The Team
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 h-auto md:h-125">
          {teams.map((team) => (
            <article
              key={team.id}
              className="relative overflow-hidden cursor-pointer group h-100"
            >
              <img
                src={team.image}
                alt={team.name}
          ...
          <article className="relative overflow-hidden bg-primary flex flex-col items-center justify-center gap-6 p-8 text-center">
            ...
            <p className="text-text-muted text-sm">
              We're always looking for talented barbers to grow with us.
            </p>
            <a
              href="https://wa.me/2348149798764?text=Hi%20De-Prime%2C%20I%27d%20like%20to%20book%20an%20appointment"
              target="_blank"
