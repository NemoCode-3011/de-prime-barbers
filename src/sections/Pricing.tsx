    ...
    <section id="pricing" className="bg-primary py-24">
      <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8 mb-16">
            {featuredServices.map((service) => {
              ...
              return (
                <article
                  key={service.name}
                  className="flex flex-col gap-3 p-6 border border-border hover:border-accent transition-colors"
                >
        ...
        <div className="max-w-2xl">
          <h3 className="text-text-primary font-heading text-2xl mb-8">
            Full Price List
          </h3>
          <dl>
        ...
        <div className="w-full h-0.5 bg-accent mb-4" />
        <h3 className="text-text-primary font-heading text-2xl mb-8 mt-16">
          Our Packages
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-3 ">
          {packages.map((pkg) => (
            <article
              key={pkg.name}
              className="flex flex-col gap-4 p-8 border border-border hover:border-accent transition-colors"
            >
